---
title: "Test"
date: 2022-03-17T01:24:58+09:00
draft: true
author: Minjoon Hong
math: true
categories:
...
- tech
---
테스트입니다. $f(x) = asdf$, ```python {import numpy }
...
const POTCAR_JSON: &'static str = include_str!("potcar.json");
...
pub fn get_recommended_potcars(elems: &Vec<String>) -> Vec<String> {
...
pub fn get_potcars_from_map(
    elems: &Vec<String>,
    potcar_map: &HashMap<String, String>,
) -> Vec<String> {
...
pub fn prompt_potcars(elems: &Vec<String>) -> Vec<String> {
